 ...
 * 
 */
@WebServiceClient(name = "CustomerService", targetNamespace = "http://gocheetasoap_service.mycompany.com/", wsdlLocation = "http://localhost:8080/GoCheetaSoap_Service/CustomerService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CUSTOMERSERVICE_QNAME = new QName("http://gocheetasoap_service.mycompany.com/", "CustomerService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/GoCheetaSoap_Service/CustomerService?wsdl");
    ...
    public CustomerService getCustomerServicePort() {
        return super.getPort(new QName("http://gocheetasoap_service.mycompany.com/", "CustomerServicePort"), CustomerService.class);
    }
    ...
    public CustomerService getCustomerServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://gocheetasoap_service.mycompany.com/", "CustomerServicePort"), CustomerService.class, features);
    }
