 ...
 * 
 */
@WebServiceClient(name = "AdminService", targetNamespace = "http://gocheetasoap_service.mycompany.com/", wsdlLocation = "http://localhost:8080/GoCheetaSoap_Service/AdminService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ADMINSERVICE_QNAME = new QName("http://gocheetasoap_service.mycompany.com/", "AdminService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/GoCheetaSoap_Service/AdminService?wsdl");
    ...
    public AdminService getAdminServicePort() {
        return super.getPort(new QName("http://gocheetasoap_service.mycompany.com/", "AdminServicePort"), AdminService.class);
    }
    ...
    public AdminService getAdminServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://gocheetasoap_service.mycompany.com/", "AdminServicePort"), AdminService.class, features);
    }
