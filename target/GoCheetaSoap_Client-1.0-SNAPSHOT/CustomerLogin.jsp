<%-- 
    ...
    Created on : Sep 2, 2022, 10:24:42 PM
    Author     : ravin
--%>
...
<div class="wrapper">
  <div class="inner-warpper text-center">
    ...
    <form action="LoginCustomerServlet" id="formvalidate" method="post">
  ...
  <div class="signup-wrapper text-center">
    <a href="RegisterCustomer.jsp">Don't have an account? <span class="text-primary">Create One</span></a>
  </div>
</div>       
    </body>
</html>
